...
{
  char cNomImgLue[250], cNomImgTest[250], cNomImgEcriteOut[250],
   ...
   allocation_tableau(HF6, OCTET, nTaille/128);
    ...
    for (int i = 0; i < nH/4; i++) {
        for (int j = 0; j < nW/4; j++) {
            ...
            MFH2[i*(nW/4)+j] = (BF[2*i*(nW/2)+2*j] + BF[(2*i+1)*(nW/2)+2*j] - BF[2*i*(nW/2)+2*j+1] - BF[(2*i+1)*(nW/2)+2*j+1])/2 + 128;
     
            MFV2[i*(nW/4)+j] = (BF[2*i*(nW/2)+2*j] - BF[(2*i+1)*(nW/2)+2*j] + BF[2*i*(nW/2)+2*j+1] - BF[(2*i+1)*(nW/2)+2*j+1])/2 + 128;
      
            HF2[i*(nW/4)+j] = BF[2*i*(nW/2)+2*j] - BF[(2*i+1)*(nW/2)+2*j] - BF[2*i*(nW/2)+2*j+1] + BF[(2*i+1)*(nW/2)+2*j+1] + 128;
        }
    }
    ...
    for (int i = 0; i < nH/8; i++) {
        for (int j = 0; j < nW/8; j++) {
            ...
            MFH3[i*(nW/8)+j] = (BF2[2*i*(nW/4)+2*j] + BF2[(2*i+1)*(nW/4)+2*j] - BF2[2*i*(nW/4)+2*j+1] - BF2[(2*i+1)*(nW/4)+2*j+1])/2 + 128;
     
            MFV3[i*(nW/8)+j] = (BF2[2*i*(nW/4)+2*j] - BF2[(2*i+1)*(nW/4)+2*j] + BF2[2*i*(nW/4)+2*j+1] - BF2[(2*i+1)*(nW/4)+2*j+1])/2 + 128;
      
            HF3[i*(nW/8)+j] = BF2[2*i*(nW/4)+2*j] - BF2[(2*i+1)*(nW/4)+2*j] - BF2[2*i*(nW/4)+2*j+1] + BF2[(2*i+1)*(nW/4)+2*j+1] + 128;
        }
    }
    ...
    for (int i = 0; i < nH/16; i++) {
        for (int j = 0; j < nW/16; j++) {
            ...
            MFH4[i*(nW/16)+j] = (BF3[2*i*(nW/8)+2*j] + BF3[(2*i+1)*(nW/8)+2*j] - BF3[2*i*(nW/8)+2*j+1] - BF3[(2*i+1)*(nW/8)+2*j+1])/2 + 128;
     
            MFV4[i*(nW/16)+j] = (BF3[2*i*(nW/8)+2*j] - BF3[(2*i+1)*(nW/8)+2*j] + BF3[2*i*(nW/8)+2*j+1] - BF3[(2*i+1)*(nW/8)+2*j+1])/2 + 128;
      
            HF4[i*(nW/16)+j] = BF3[2*i*(nW/8)+2*j] - BF3[(2*i+1)*(nW/8)+2*j] - BF3[2*i*(nW/8)+2*j+1] + BF3[(2*i+1)*(nW/8)+2*j+1] + 128;
        }
    }
    ...
    for (int i = 0; i < nH/32; i++) {
        for (int j = 0; j < nW/32; j++) {
            ...
            MFH5[i*(nW/32)+j] = (BF4[2*i*(nW/16)+2*j] + BF4[(2*i+1)*(nW/16)+2*j] - BF4[2*i*(nW/16)+2*j+1] - BF4[(2*i+1)*(nW/16)+2*j+1])/2 + 128;
     
            MFV5[i*(nW/32)+j] = (BF4[2*i*(nW/16)+2*j] - BF4[(2*i+1)*(nW/16)+2*j] + BF4[2*i*(nW/16)+2*j+1] - BF4[(2*i+1)*(nW/16)+2*j+1])/2 + 128;
      
            HF5[i*(nW/32)+j] = BF4[2*i*(nW/16)+2*j] - BF4[(2*i+1)*(nW/16)+2*j] - BF4[2*i*(nW/16)+2*j+1] + BF4[(2*i+1)*(nW/16)+2*j+1] + 128;
        }
    }
    ...
    for (int i = 0; i < nH/64; i++) {
        for (int j = 0; j < nW/64; j++) {
            ...
            MFH6[i*(nW/64)+j] = (BF5[2*i*(nW/32)+2*j] + BF5[(2*i+1)*(nW/32)+2*j] - BF5[2*i*(nW/32)+2*j+1] - BF5[(2*i+1)*(nW/32)+2*j+1])/2 + 128;
     
            MFV6[i*(nW/64)+j] = (BF5[2*i*(nW/32)+2*j] - BF5[(2*i+1)*(nW/32)+2*j] + BF5[2*i*(nW/32)+2*j+1] - BF5[(2*i+1)*(nW/32)+2*j+1])/2 + 128;
      
            HF6[i*(nW/64)+j] = BF5[2*i*(nW/32)+2*j] - BF5[(2*i+1)*(nW/32)+2*j] - BF5[2*i*(nW/32)+2*j+1] + BF5[(2*i+1)*(nW/32)+2*j+1] + 128;
        }
    }
